...
public class HumidityRepository : IHumidityRepository{
    public IEnumerable<HumidityModel> GetAll(DateTime start_at)
    {
        var url = "http://43.131.48.203:8083/data/Humidity/list?start_at=" + "2024-05-12 18:10:30";
        ...
        var result = Newtonsoft.Json.JsonConvert.DeserializeObject<MeasuredHumidity>(responseBody);
